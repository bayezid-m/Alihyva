                ...
                <Toolbar>
                    ...
                    {token ?
                        <div style={{ display: 'flex', gap: 10 }}>
                            <Link to='profile'><p style={{ color: 'white' }}>{user?.firstName}</p></Link>
                    ...
                    <Link to={'/cart'}><Button variant="contained" sx={{ margin: 2, border: 'none', position: 'relative', color: 'white' }}><ShoppingCartIcon />
                        <div>
                            {cart.length}
                        </div>
                    </Button></Link>
